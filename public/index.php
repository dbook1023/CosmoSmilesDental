...
<body class="bg-white">
    ...
    <section class="section-full hero">
        <div class="container hero-flex">
            ...
            <div class="hero-image">
                ...
                ?>
                <img src="<?php echo $heroImgExists ? '/Cosmo_Smiles_Dental_Clinic/public' . htmlspecialchars($homeContent['hero_bg_image']) : 'assets/images/csdc.jpg'; ?>" alt="Cosmo Smiles Dental Clinic">
            </div>
        </div>
    </section>
    ...
    <section class="section-full" style="background: linear-gradient(135deg, rgba(3, 7, 79, 0.92) 0%, rgba(3, 7, 79, 0.85) 40%, rgba(13, 91, 185, 0.80) 100%), url('/Cosmo_Smiles_Dental_Clinic/public/assets/images/csdc.jpg') center/cover no-repeat; background-attachment: fixed;">
        <div class="container">
            <div class="section-header">

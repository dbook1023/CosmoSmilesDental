        ...
        <div class="container">
            <div class="tech-flex">
                ...
                <div class="tech-image">
                    <img src="<?php echo !empty($servicesContent['tech_img']) ? URL_ROOT . ltrim($servicesContent['tech_img'], '/') : 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?q=80&w=2070&auto=format&fit=crop'; ?>" alt="Advanced Clinical Tech">
                </div>
            </div>
        </div>
    </section>
